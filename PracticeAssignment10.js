...
function getAllParagraphs() {
    return myPage.querySelectorAll("myPage");
}
...
function makeItalic()
{
    const text = document.querySelectorAll('.even');
    text.forEach( (txt) => 
    {
...
function createBorders(){
        const myPage = document.querySelector("section");
        const table = myPage.querySelector("table"); 
...
function getTheListItem(num1, num2) 
{
    ...
    document.querySelector("div").innerHTML = index.innerHTML;
